...
<div id="he-titles" class="he-container<?php echo esc_attr( $title_container_class ); ?>">
	<div class="saving">
		<p>
	...
	<button class="button cancel-select-title" type="button"><?php esc_html_e( 'Cancel', 'headline-envy' ); ?></button>
	<a href="https://www.optimizely.com/results?experiment_id=<?php echo absint( $title_experiment_id ); ?>" class="view-experiment" target="_blank"><?php esc_html_e( 'View title experiment details', 'headline-envy' ); ?></a>
</div>
